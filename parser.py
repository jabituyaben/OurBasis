...
with open(os.path.join(dirname, 'pulsedata.dat'), 'rb') as f:
    a = BitArray(f)
...
while i < len(valid_samples):
    ...
    while z < 60:
        ...
        if heartrate > 50 and heartrate < 100:
...
with open('data.csv', 'w', newline='') as csvfile:
    ...
    writer.writerow(['Time', 'HR','Skin_Temp','GSR','AirTemp','Movement','HR_stdv','GSR_stdv','unkown_stdv'])
    for row in list:
